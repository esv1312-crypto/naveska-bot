# bot.py — финальная стабильная версия для Render.com
...
# Если Telegram заблокирован на сервере — раскомментируй и используй прокси
# bot = Bot(token=BOT_TOKEN, proxy='http://185.199.230.45:8383')
bot = Bot(token=BOT_TOKEN)  # ← основная версия без прокси
